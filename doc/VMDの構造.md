...
## モージョン Interpolationの解析結果

調査: 2020/09/25

Ver 9.32 (64bit ver) だと、モーションの補完データ ６４バイトのデータが下記のようになっている模様
先頭16バイトでもコピーミスが発生しているのか、00になっている。
先頭からバイトを取り出して、"00"以外ならば読み取りを終了する取り込み方が良いと思われる。
...
出力に関しては、１６バイト、１５バイト×３、"00 00 00" で問題ないかと思われる。
